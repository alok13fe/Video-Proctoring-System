...
export default function Lobby({ isMicOn, setIsMicOn, isCameraOn, setIsCameraOn, videoTrack, setVideoTrack, audioTrack, setAudioTrack, setMeetStarted }: LobbyProps){
  ...
  function handleJoin(){
    if(!videoTrack || !audioTrack){
      toast.error('Please turn Camera On!');
      return;
    }
    setError('');
    if(socket){
